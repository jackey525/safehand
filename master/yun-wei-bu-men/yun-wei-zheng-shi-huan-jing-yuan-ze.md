...
序号. 	用途	          软件	          版本号
1	   JAVA虚拟机	    JDK	          1.8
2	   WEB服务器	      nginx	        1.19.9.1
3	   WEB服务器	      openresty.  	1.19.6.2
4	   搜索引擎	      elasticsearch	7.6.2
5	   消息队列	      kafka	        2.2.1
6	   消息队列	      rabbitmq      3.12.7
7	   关系型数据库	    MySQL.      	5.7
8	   缓存	          redis	        6.2.19
9. 	 数据收集引擎	    logstash	    6.2.4
10	 NOSQL	        mongodb	      4.4
11	 操作系统	      centos	      7.9
12	 脚本语言	      Python	      3.6
13	 监控软件	      zabbix	      4.2
14	 监控软件	      ELK	          7.6.2
15   数据收集引擎     vector        0.51.1
```
